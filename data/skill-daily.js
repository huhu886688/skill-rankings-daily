window.SKILL_DAILY_DATA = {
  ...
  "insights": [
    {
      "title": "技能创建器 仍是社区影响力核心",
      "body": "帮助用户把经验、工具链和流程封装成可复用的 SKILL.md，是整个 Agent Skill 生态的生产入口。 当前以 父仓库约 145K ★ 领跑年度综合榜，说明创建、发现、安装和可复用工作流仍是 Skill 生态的基础增长链路。",
      "tone": "cyan"
    },
    {
      "title": "找技能 是本期动能观察重点",
    ...
    {
      "title": "文档办公 的落地价值更突出",
      "body": "演示文稿 位于该方向首位，创建、修改、渲染并检查 PPTX。",
      "tone": "violet"
    }
  ],
  "sections": [
      ...
      "items": [
        {
          ...
          "metric": "父仓库约 145K ★",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：定义和扩展 skill 的基础能力，受官方仓库高热度、跨生态引用和安装需求共同加权。（今日信号：热度 98 / 场景 92）",
        ...
        },
        {
          ...
          "metric": "父仓库约 145K ★",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：新用户接触 skill 生态时最先需要发现、比较和安装，目录热度与跨仓库入口价值很高。（今日信号：热度 98 / 场景 88）",
        ...
        },
        {
          ...
          "metric": "父仓库约 34.3K ★",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：GitHub 官方社区合集带来强公信力，instructions、agents 和 skills 配置在开发者生态中复用度高。（今日信号：热度 86 / 场景 92）",
        ...
        },
        {
          ...
          "metric": "父仓库约 39.4K ★",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：可安装 skills 库和 installer CLI 把发现、下载、安装、bundle 复用串起来，安装信号权重高。（今日信号：热度 87 / 场景 88）",
        ...
        },
        {
          ...
          "metric": "父仓库约 57.3K ★",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：设计类父仓库热度高，且前端界面是 coding agent 最常见的真实交付场景之一。（今日信号：热度 91 / 场景 95）",
        ...
        },
        {
          ...
          "metric": "父仓库约 47.7K ★",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：工程向 agent skills 拥有高父仓库热度，且开发、调试、测试、重构是最高频 agent 使用场景。（今日信号：热度 89 / 场景 98）",
        ...
        },
        {
          ...
          "metric": "父仓库约 45.4K ★",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：Claude Code 的 commands、hooks、agents 与 skills 被大量开发者复用，工程工作流引用信号强。（今日信号：热度 89 / 场景 93）",
        ...
        },
        {
          ...
          "metric": "办公数据高频",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：CSV/XLSX 清洗、公式、图表和报表是高频办公与数据场景，跨任务复用度高。（今日信号：热度 0 / 场景 92）",
        ...
        },
        {
          ...
          "metric": "官方复用强",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：正式文档、PDF 阅读、批注、排版和核验是稳定高频场景，官方共享 skill 复用价值高。（今日信号：热度 0 / 场景 92）",
        ...
        },
        {
          ...
          "metric": "交付场景强",
          "type": "单 Skill 综合影响力",
          "reason": "上榜理由：PPT/幻灯片是高频可见交付物，独立项目和官方 skill 都有明显复用信号。（今日信号：热度 0 / 场景 94）",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "type": "独立项目型",
          "reason": "上榜理由：演示稿生成需求近期仍强。（今日信号：动能 41 / 更新 22）",
        ...
        },
        {
          ...
          "type": "社区索引型",
          "reason": "上榜理由：持续被用作工作流选型入口。（今日信号：动能 41 / 更新 22）",
        ...
        },
        {
          ...
          "type": "社区索引型",
          "reason": "上榜理由：跨平台 agent skill 目录价值明显。（今日信号：动能 38 / 更新 22）",
        ...
        },
        {
          ...
          "type": "独立项目型",
          "reason": "上榜理由：图表自动化交付需求升温。（今日信号：动能 34 / 更新 22）",
      ...
      "items": [
        {
          ...
          "metric": "20.5K ★",
          "type": "官方共享型",
          "reason": "上榜理由：数据清洗、公式和报表输出覆盖面最广。（今日信号：热度 82 / 场景 96）",
        ...
        },
        {
          ...
          "metric": "场景价值分",
          "type": "专项场景型",
          "reason": "上榜理由：分析结果需要可视化表达。（今日信号：热度 0 / 场景 86）",
        ...
        },
        {
          ...
          "metric": "场景价值分",
          "type": "专项场景型",
          "reason": "上榜理由：站点增长和内容运营需求明确。（今日信号：热度 0 / 场景 82）",
      ...
      "items": [
        {
          ...
          "metric": "57.3K ★",
          "type": "官方共享型",
          "reason": "上榜理由：开发交付里最常被复用。（今日信号：热度 91 / 场景 95）",
        ...
        },
        {
          ...
          "metric": "20.5K ★",
          "type": "官方共享型",
          "reason": "上榜理由：海报、产品图和素材生产需求广。（今日信号：热度 82 / 场景 94）",
        ...
        },
        {
          ...
          "metric": "57.3K ★",
          "type": "专项场景型",
          "reason": "上榜理由：网页设计规范能显著提升落地质量。（今日信号：热度 91 / 场景 90）",
        ...
        },
        {
          ...
          "metric": "场景价值分",
          "type": "专项场景型",
          "reason": "上榜理由：视频自动化交付价值高。（今日信号：热度 0 / 场景 82）",
      ...
      "items": [
        {
          ...
          "metric": "20.5K ★",
          "type": "官方共享型",
          "reason": "上榜理由：路演、汇报和方案交付频率高。（今日信号：热度 82 / 场景 94）",
        ...
        },
        {
          ...
          "metric": "20.5K ★",
          "type": "官方共享型",
          "reason": "上榜理由：长文档读取和抽取是高频办公任务。（今日信号：热度 82 / 场景 90）",
        ...
        },
        {
          ...
          "metric": "20.5K ★",
          "type": "官方共享型",
          "reason": "上榜理由：正式文档的生成和核验需求稳定。（今日信号：热度 82 / 场景 90）",
      ...
      "items": [
        {
          ...
          "metric": "57.3K ★",
          "type": "官方共享型",
          "reason": "上榜理由：代码能跑之后，最需要它提升产品质感。（今日信号：热度 91 / 场景 95）",
        ...
        },
        {
          ...
          "metric": "145K ★",
          "type": "专项场景型",
          "reason": "上榜理由：开发者能把团队 SOP 固化成 skill。（今日信号：热度 98 / 场景 92）",
  ...
  "generatedAt": "2026-06-15T16:14:27.980Z"
};
